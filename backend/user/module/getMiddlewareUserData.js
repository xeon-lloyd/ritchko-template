...
module.exports = async function(tokenData){
    ...
    let userData = await util.token.redisSessionStorage.get(cacheKey);
    ...
    await util.token.redisSessionStorage.set(cacheKey, JSON.stringify(userData), USER_CACHE_EXPIRE);
